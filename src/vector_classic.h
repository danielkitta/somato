...
struct Vector233
{
  ...
  inline void set(const Vector4::value_type* a,
                  const Vector4::value_type* b,
                  const Vector4::value_type* c);
...
inline void Vector233::set(const Vector4::value_type* a,
                           const Vector4::value_type* b,
                           const Vector4::value_type* c)
{
  data[0][0] = a[0];
...
{
  return (Vector4::equal_(a.data[0], b.data[0])
       && Vector4::equal_(a.data[1], b.data[1]));
}
